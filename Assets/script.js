...
//this makes the red button that says generate password start the function in line 61 which will begin by calling on line 17 by clicking it
...
function popUpAlert(){
  ...
  // If the user does not input a number(in integer format) between 8-128 it will not let them continue to the rest of the ifs and it will return false for function on line 61 after the alert
  passwordLength= parseInt(prompt("What would you like your password length to be? 8-128 characters"));
   ...
   //this will count the number of answers true above and if all where clicked false then it will return false for function on line 61 since var number will remain zero
